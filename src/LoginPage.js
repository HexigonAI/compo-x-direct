...
const LoginPage = () => {
  return (
    ...
    <div class="bg-animation">
      <div class="preloader"><img src="images/Union-1.svg" width="50" height="Auto" alt="" class="preloader-logo"/></div>
    ...
    <div class="account-wrapper-dark">
      <div class="account-card-dark">
        <div>
          ...
          <div class="account-caption">This site is protected by reCAPTCHA and the Hexigon&#x27;s <a href="#" class="account-link-small">Privacy Policy</a> and Terms of Service apply as an Hexigon AI, Inc. Product.</div>
        </div>
      </div>
      <div class="div-block-9"><img src="images/hexigon-ai-logo.svg" loading="lazy" width="100" alt="" class="hexigon-ai-logo"/>
        <div class="account-link-row">
          <a href="http://hexigon.ai" class="account-link-side">Go to Hexigon.ai</a>
          <div class="account-dot"></div>
          <a href="http://hexigon.ai/support" class="account-link-side">Compo Support</a>
          <div class="account-dot"></div>
          <a href="http://hexigon.ai/terms" class="account-link-side">Terms</a>
          <div class="account-dot"></div>
          <a href="http://hexigon.ai/privacy" class="account-link-side">Privacy</a>
        </div>
      </div>
    </div>
  </div>
