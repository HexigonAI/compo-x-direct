      ...
      <div className=" bg-[#31353C] relative transform overflow-hidden rounded-lg text-left shadow-xl transition-all w-[26rem]">
        ...
        <div className=" px-4 pb-4 pt-2 ">
          <div className="sm:flex sm:items-start">
            <div className=" ">
              <h3 className="text-base font-semibold  text-white" id="modal-title">Deactivate account</h3>
              <div className=" w-96">
        ...
        <div className="bg-[#6366F1] px-4 py-2 sm:flex sm:flex-row-reverse sm:px-6">
          <button onClick={(e) =>{ fetchPromptData(e, 'Create a Hero section'); setShowWelcome(false); console.log('test');}} type="button" className=" bg-transparent w-full text-white">Generate</button>
        </div>
      </div>
    </div>
  </div>
